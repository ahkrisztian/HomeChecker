...
{
    public class OpenAddRoomViewCommand : CommandBase
    {
        ...
        public OpenAddRoomViewCommand(NavigationStore navigationStore, RoomListItemMade roomListStore, RoomListViewStore roomListViewStore,
        ...
        {
            _navigationStore.CurrentViewModel = new AddRoomFormViewModel(_roomListStore, _navigationStore, 
                _roomListViewStore, _selectedRoomStore, _roomListViewModel, _roomDetailsViewModel, _roomListViewUpdateRoom);
        }
    }
}
